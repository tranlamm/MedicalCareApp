...
//		mom.add(backgroundMom);
		...
		scrollPaneMom.setBounds(42, 220, 1029, 335);
		mom.add(scrollPaneMom);
		
		// button
		JButton btnInsertMom = new JButton("Insert");
		btnInsertMom.setBounds(1105, 220, 94, 35);
		...
		btnDeleteMom.setBounds(1105, 420, 94, 35);
		...
		btnUpdateMom.setBounds(1105, 320, 94, 35);
		...
		btnResetMom.setBounds(1105, 520, 94, 35);
		...
		lblNewLabel_2.setBounds(42, 580, 100, 48);
		...
		lblNewLabel_11.setBounds(237, 633, 36, 35);
		lblNewLabel_11.setFont(new Font("Tahoma", Font.BOLD, 16));
		mom.add(lblNewLabel_11);
		
		idSearchTextMom = new JTextField();
		idSearchTextMom.setBounds(316, 633, 472, 35);
		...
		idRadioMom.setBounds(43, 739, 58, 23);
		...
		nameRadioMom.setBounds(123, 739, 72, 23);
		...
		btnSearchMom.setBounds(42, 638, 153, 74);
		...
		detailBtn.setBounds(877, 633, 194, 96);
...
//		mom.add(backgroundMom);
		...
		btnAdd.setBounds(1098, 209, 103, 48);
		...
		btnEdit.setBounds(1098, 309, 103, 48);
		...
		btnDelete.setBounds(1098, 409, 103, 48);
		...
		KidSearchById.setBounds(296, 637, 436, 35);
		...
		KidSearchByName.setBounds(296, 712, 436, 35);
		...
		idRadioKid.setBounds(36, 725, 58, 23);
		kid.add(idRadioKid);
		...
		nameRadioKid.setBounds(121, 725, 72, 23);
		...
		btnWH.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnWH.setBounds(833, 703, 204, 48);
		...
		btnHM.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnHM.setBounds(833, 628, 204, 48);
	...
	public void jPanelClinic()
	{
		...
		nameClinic.setBounds(1015, 464, 186, 42);
		clinic.add(nameClinic);
		
		JLabel lblNewLabel_1_2 = new JLabel("Email");
		lblNewLabel_1_2.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel_1_2.setBounds(866, 604, 81, 42);
		...
		phoneNumberClinic.setBounds(1015, 536, 186, 42);
		...
		updateBtn.setBounds(1064, 205, 139, 51);
		...
		deleteBtn.setBounds(866, 205, 139, 51);
		...
		resetBtn.setBounds(1064, 300, 139, 51);
		...
		searchClinic.setBounds(245, 707, 579, 51);
		...
		searchBtn.setBounds(46, 707, 166, 51);
		...
		idRadioClinic.setBounds(46, 774, 52, 23);
		...
		nameRadioClinic.setBounds(141, 774, 104, 23);
	...
	public void jPanelEvent()
	{
		...
		nameEvent.setBounds(771, 197, 253, 31);
		event.add(nameEvent);
		...
		insertEvent.setBounds(1060, 199, 100, 27);
		...
		deleteEvent.setBounds(1060, 267, 100, 27);
		...
		resetEvent.setBounds(1060, 334, 100, 27);
		...
		lblNewLabel_3_1_2.setBounds(230, 734, 48, 23);
		...
		searchTextEvent.setBounds(288, 724, 313, 44);
		...
		searchEvent.setBounds(49, 723, 140, 44);
		...
		lblNewLabel_3_1_1_2.setBounds(661, 504, 87, 23);
		...
		lblNewLabel_3_1_1_1_1.setBounds(661, 549, 48, 23);
		...
		lblNewLabel_3_1_1_1_2.setBounds(661, 603, 38, 23);
		...
		lblNewLabel_3_1_1_1_3.setBounds(661, 656, 59, 23);
		...
		lblNewLabel_3_1_1_1_4.setBounds(662, 710, 72, 23);
		event.add(lblNewLabel_3_1_1_1_4);
		
		JTextField textField = new JTextField();
		textField.setFont(new Font("Tahoma", Font.PLAIN, 14));
		textField.setColumns(10);
		textField.setBounds(771, 545, 253, 31);
		event.add(textField);
		
		JTextField textField_1 = new JTextField();
		textField_1.setFont(new Font("Tahoma", Font.PLAIN, 14));
		textField_1.setColumns(10);
		textField_1.setBounds(771, 599, 253, 31);
		event.add(textField_1);
		
		JTextField textField_2 = new JTextField();
		textField_2.setFont(new Font("Tahoma", Font.PLAIN, 14));
		textField_2.setColumns(10);
		textField_2.setBounds(771, 652, 253, 31);
		event.add(textField_2);
		JScrollPane jScrollArea2 = new JScrollPane(); 
		jScrollArea2.setBounds(771, 710, 253, 90);
		...
		btnSend.setBounds(1060, 740, 140, 60);
